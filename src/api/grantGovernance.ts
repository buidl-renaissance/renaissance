...
const abi = require('./GrantGovernance.json'); // Assuming you have the ABI of your contract

// Initialize Web3 with your provider
const web3 = new Web3('http://localhost:8545'); // Update with your provider URL

const contractAddress = '0x123...'; // Update with the contract address in truffle develop
